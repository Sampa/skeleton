		...
		array(
		    ...
		    'value'=>
			    'Chtml::link(CHtml::tag("i",array("class"=>"icon-eye-open"),""),"#",  	
			    	array("class"=>"btn btn-success view","onclick"=>"renderView($data->id,\"/<?php echo $this->class2id($this->modelClass); ?>/view?id=$data->id\")")).
	   		     Chtml::link(CHtml::tag("i",array("class"=>"icon-pencil"),""),"#",
	   		     	array("class"=>"btn btn-primary view","onclick"=>"renderUpdateForm($data->id,\"<?php echo $this->class2id($this->modelClass); ?>\")")).
				Chtml::link(CHtml::tag("i",array("class"=>"icon-trash"),""),"#",
			  	 	array("class"=>"btn btn-danger view","onclick"=>"delete_record($data->id,\"<?php echo $this->class2id($this->modelClass); ?>\")"))',
